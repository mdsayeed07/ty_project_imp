...
$name1 = $pack1 = $batch1 = $gname1 = $quantity1 = $mrp1 = $sup1 = '';
    ...
    if (isset($_POST["submit"])) {
        ...
        $mfg = $_POST["mfg_date"];
        try {
            $sql_update = "UPDATE medinfo SET med_name = '$name', med_pack = '$pack', batch_id = '$batch', mfg_date = '$mfg',exp_date='$exp',gen_name = '$gname', quantity = $quantity, mrp = $mrp, med_sup = '$sup' WHERE med_no='$id1'";
