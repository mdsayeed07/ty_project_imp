...
if (isset($_POST["submit"])) {
    $id = filter_input(INPUT_POST,"supid",FILTER_VALIDATE_INT);
    ...
    try {
        $sql = "UPDATE SUPINFO SET sup_id = $id sup_name = '$name', sup_email = '$email', sup_contact = $contact, sup_address = '$address' WHERE sup_id=$id1";
        $result = mysqli_query($conn, $sql);
        if ($result) {
