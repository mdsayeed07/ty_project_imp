...
<?php    
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sup_id = generateRandomSupId(); // Generate a new random sup_id for each submission

        try{
            $sql = "INSERT INTO SUPINFO(sup_id, sup_name, sup_email, sup_contact, sup_address) VALUES($sup_id, '$name', '$email', $contact, '$address')";
