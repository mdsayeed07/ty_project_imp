...
if(isset($_GET['updateid'])) {
    ...
    if (isset($_POST["submit"])) {
        ...
        try {
            $sql_update = "UPDATE cinfo SET c_name = '$name', c_contact = $contact, c_address = '$address', description = '$desc', hospital_name = '$hosp', doc_name = '$dname' WHERE c_id='$id1'";
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <form action="update.php?updateid=<?php echo $id1; ?>" method="POST">
                ...
                <input type="text" name = 'dname' placeholder="Doctor Name" value = '<?php echo $dname1; ?>'> <br><hr>
