    ...
    <div class="container-fluid">
        ...
        <header>
            ...
            <form action = "addc.php" method = "POST">
                ...
                <input type="text" name = 'dname' placeholder="Doctor Name"> <br><hr>
...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        try{
            $sql = "INSERT INTO cinfo(c_name,c_contact,c_address,description,hospital_name,doc_name) VALUES('$cname',$ccontact,'$caddress','$desc','$hospital','$dname')";
