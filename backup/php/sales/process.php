...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($total === null) {
        ...
        $total_price_before_discount = $mrp * $squantity;

// Calculate the discount amount
$disc_amount = $total_price_before_discount * ($disc / 100);

// Calculate the total price after discount
$total_price_after_discount = $total_price_before_discount - $disc_amount;

// Calculate the GST amount on the total price after discount
$gst_amount = $total_price_after_discount * ($gst / 100);

// Calculate the final total sales including GST
$total_sales = $total_price_after_discount + $gst_amount;
    ...
    mysqli_stmt_bind_param($stmt1, "issssiiddss", $invoice, $customer, $med_name, $batch_id, $pay, $squantity, $sprice, $disc, $gst, $total_sales, $date);
