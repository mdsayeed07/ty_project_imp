    ...
    <div class="container-fluid">
            ...
            <header>
                ...
                <div class="right-dash">        
                    <div class="dropdown">            
                        ...
                        <a href="/pharmacy-management-system/php/report/SReport/customsales.php"><i class="fa fa-book"></i>&nbsp; Custom Sale Report</a>
        ...
        <script>
            function printTable() {
                ...
                printWindow.document.write("<p style = 'text-align:center;'>(Mob):996757323 / 9978745705</p><br>"); // Address added here
                printWindow.document.write("<hr style = 'font-weight:bold'>");
                printWindow.document.write("<h2 style='text-align:center'>Sales Report</h2>");
