        ...
        <div class="container">        
            <header>
                ...
                <div class="right-dash">        
                    <div class="dropdown">            
                        ...
                        <a href="/imp_project/php/admin/admindetails.php"><i class="fas fa-user"></i>&nbsp; Admin Details</a>
            ...
            <div>
                ...
                <div class="quick-actions">
                    ...
                    <a href="/imp_project/php/customer/addc.php">Add New Customer</a>
                    <a href="/imp_project/php/sales/addsales.php">Add New Sales</a>
                    <a href="/imp_project/php/supplier/addsup.php">Add New Supplier</a>
                    <a href="/imp_project/php/purchase/addp.php">Add New Purchase</a>
                    <a href="/imp_project/php/medicine/addm.php">Add New Medicine</a>
                    <a href="/imp_project/php/invoicing/tax/invoice.php">View Tax Invoice</a>
                </div><br><br><br><hr>
