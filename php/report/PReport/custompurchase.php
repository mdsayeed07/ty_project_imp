...
<body>
    ...
    <div class="container-fluid">
        <div class="container">
            <header>
                <div class="left-dash">
                    <h1>Purchase Report (Custom)</h1>
                    <nobr><i class="fa fa-book">&nbsp; Purchase Report Custom Search</i></nobr>
                </div>
                <div class="right-dash">        
                    <div class="dropdown">            
                        ...
                        <!-- <a href="/pharmacy-management-system/php/report/PReport/custompurchase.php"><i class="fa fa-book"></i>&nbsp; Custom Purchase Report</a> -->
            ...
            <table id="purchaseTable">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><h2 id="totalAmount" style='color: green;'><?php echo $total; ?></h2></td>
                    </tr>
                </tfoot>
            </table>
            <div>
