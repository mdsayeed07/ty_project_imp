...
window.onload = function() {
    document.getElementById("sort-select").addEventListener("change", function() {
        ...
        if (selectedIndex === "1") {
            ...
            sortTableByPaymentMethod("sales-table", 5);
        } else if (selectedIndex === "5") {
            sortTableByQuantity("sales-table", 6);
        } else if (selectedIndex === "6") {
            sortTableBySellingPrice("sales-table", 7);
        } else if (selectedIndex === "7") {
            sortTableByDiscount("sales-table", 8);
        } else if (selectedIndex === "8") {
            sortTableByGST("sales-table", 9);
        } else if (selectedIndex === "9") {
            sortTableByTotalSales("sales-table", 10);
        } else if (selectedIndex === "10") {
            sortTableBySalesDate("sales-table", 11);
        }
