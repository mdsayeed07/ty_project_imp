document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("sort-select").addEventListener("change", function() {
        ...
        if (selectedIndex === "1") { // If Customer Name is selected
            sortTableByCustomerName();
        } else if (selectedIndex === "2") { // If Customer Address is selected
            sortTableByCustomerAddress();
        } else if (selectedIndex === "3") { // If Hospital Name is selected
